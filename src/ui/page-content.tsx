        ...
        return (
            <article className="prose prose-xl mx-auto mt-5 pb-14">
                ...
                <p>
                    ...
                    mod theme/style buildings. <b>Credits</b> for the buildings go to the style authors listed
                    in the sidebar next to the style name. I created this site to make it easy to visually
                    browse the buildings from different styles and categories at the same time.
                </p>
                <p>
                    To get started, select one or more styles/categories from the sidebar and start exploring
                    the buildings! You can also search for a building name, hut block, or category—just select
                    all the styles you want to search from first. You can see the back of most buildings by
                    clicking on the image.
                </p>
                <p>
                    Note: This page only shows simple pics of the buildings. Minecolonies has a Patreon where
                    you can support them and get access to their official <b>schematics server</b> if you want
                    to browse and inspect the buildings more closely in-game. Read more about it on their{" "}
